...
export const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    text: "Face the panel. Defend your vision. Win them over.",
  },
  {
    step: "04",
...
export const TRACKS: Track[] = [
  {
    ...
    icon: "◈",
    name: "AI & Humans",
    pitch: "Intelligence that makes everyday life more human.",
    color: "#4b8dff",
  },
  {
    id: "fintech",
    icon: "↗",
    name: "Fintech",
    pitch: "Reimagine how communities access and move money.",
    color: "#f4b400",
  },
  {
    id: "sustainability",
    icon: "✦",
    name: "Sustainability",
    pitch: "Turn climate pressure into measurable progress.",
    color: "#46c985",
  },
  {
    id: "smart-cities",
    icon: "⌁",
    name: "Smart Cities",
    pitch: "Design the systems that make cities feel alive.",
    color: "#ed7759",
  },
  {
    id: "education",
    icon: "◎",
    name: "Education",
    pitch: "Unlock better ways to learn, teach and share.",
    color: "#a278ff",
  },
  {
    id: "open",
    ...
    pitch: "No box. No brief. Just your boldest venture.",
    color: "#57c9dd",
  },
];
...
export const PRIZES: Prize[] = [
  {
    ...
    unit: "TND",
    glyph: "✦",
    className: "prize-gold",
    perks: ["Seed funding offer", "6 months of mentorship", "Incubation seat"],
  },
  {
    rank: "02 / SILVER",
    tier: "The Challenger",
    ...
    unit: "TND",
    glyph: "✧",
    className: "prize-silver",
    perks: ["Growth grant", "3 months of mentorship", "Investor intros"],
  },
  {
    rank: "03 / BRONZE",
    tier: "The Spark",
    ...
    unit: "TND",
    glyph: "◌",
    className: "prize-bronze",
    perks: ["Kickstart grant", "Workshop access", "Community spotlight"],
  },
];
...
export const IDEAS: Idea[] = [
  {
    ...
    track: "AI & Humans",
    author: "Team Pulse",
    blurb: "Cut clinic waiting times with predictive scheduling.",
    seeking: "Backend · Data",
  },
  {
    title: "GreenLedger",
    track: "Sustainability",
    author: "Team Terra",
    blurb: "Carbon tracking for small Tunisian businesses.",
    seeking: "Frontend · Business",
  },
  {
    title: "Dinar",
    track: "Fintech",
    author: "Solo · Rami",
    blurb: "Micro-savings that round up every purchase.",
    seeking: "Mobile · Design",
  },
  {
    title: "CityPulse",
    track: "Smart Cities",
    author: "Team Medina",
    blurb: "Crowd-sourced maps of city issues in real time.",
    seeking: "DevOps · UI/UX",
  },
  {
    title: "Tutorly",
    track: "Education",
    author: "Solo · Nour",
    blurb: "Peer tutoring marketplace for students.",
    seeking: "Full-stack",
  },
  {
    title: "Loop",
    ...
    author: "Team Vertex",
    blurb: "Turn local recycling into rewards.",
    seeking: "AI · Product",
  },
];
